...
class PostageAndPackingNoMerchandiseReport extends FreeTibetReport{

  protected $computerName = "no_merchandise_pandp";

  protected $data = array();

  public function __construct(){
    $this->name = t("Monthly breakdown of postage and packing associated with orders that do not include merchandise");
  ...
  public function outputCSV() {
    $orderCollection = $this->getOrdersIncludingADonationAndNoMerchandise();
